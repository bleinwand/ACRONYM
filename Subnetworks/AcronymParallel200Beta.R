...
node_types = rep("beta",2) 
node_sociabilities = c(sort(rbeta(200, shape1 = 1.5, shape2=.9)), sort(rbeta(200, shape1 = .8, shape2=1.4)) )
...
save.image(file = "DOROTHY_Acronym200Beta.RData")
