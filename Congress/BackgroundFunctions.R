...
result = (list(NA, NA, NA, NA, NA, NA, NA, NA, estimate_1d, estimate_1d, estimate_1d, NA))
 ...
 local_start_time = proc.time()
  ...
  if(is.na(normal5)){normal5 = (list(NA, NA, NA, NA, NA, NA, NA, Inf, NA, NA, NA))}
  if(is.na(exp5)){exp5 = (list(NA, NA, NA, NA, NA, NA, NA, Inf, NA, NA, NA))}
  if(is.na(negexp5)){negexp5 =(list(NA, NA, NA, NA, NA, NA, NA, Inf, NA, NA, NA))}
  if(is.na(linear5)){linear5 =(list(NA, NA, NA, NA, NA, NA, NA, Inf, NA, NA, NA))}
